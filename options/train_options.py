...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr_D', type=float, default=1.0, help='initial learning rate for adam')
        self.parser.add_argument('--training_dataset',type=str,default='',help='training use which dataset')
        self.parser.add_argument('--event_number', type=str, default='10000', help='event_number')

        # weight for centain losses
        self.parser.add_argument('--lambda_DC', type=float, default=0.5, help='weight for dark channel loss')
        self.parser.add_argument('--lambda_TV', type=float, default=0.05, help='weight for total variational loss')
        self.parser.add_argument('--lambda_dehaze', type=float, default=1.0, help='weight for dehaze loss')
        ...
        self.parser.add_argument('--is_flip_rotate', action='store_true')
